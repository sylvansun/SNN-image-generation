...
class Generator(nn.Module):
    ...
    def forward(self, x):
        ...
        for step in range(self.num_steps):
            ...
            spk5_rec.append(self.tanh(spk5))
...
class Discriminator(nn.Module):
    def __init__(
        self, dis_inputs=28 * 28, dis_num_hidden1=512, dis_num_hidden2=256, dis_num_outputs=1, num_steps=25, beta=0.95
    ):
        super().__init__()
        self.num_steps = num_steps
    ...
    def forward(self, x):
        ...
        for step in range(self.num_steps):
            cur1 = self.maxpool(self.conv1(x.view(64,1,28,28)))
            spk1, mem1 = self.lif1(cur1, mem1)
            cur2 = self.maxpool(self.conv2(spk1))
            spk2, mem2 = self.lif2(cur2, mem2)
            cur3 = self.fc1(spk2.view(64,-1))
            spk3, mem3 = self.lif3(cur3, mem3)
            spk3_rec.append(self.sigmoid(spk3))
